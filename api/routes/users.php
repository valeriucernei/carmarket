 ...
 */
 ...
 /**
  * @OA\Get(path="/accounts", tags={"users"}, security={{"ApiKeyAuth":{}}},
  ...
  */
  ...
  /**
   * @OA\Get(path="/account/{id}", tags={"users"}, security={{"ApiKeyAuth":{}}},
  ...
  /**
   * @OA\Post(path="/register", tags={"users"}, security={{"ApiKeyAuth":{}}},
  ...
  /**
   * @OA\Put(path="/account/{id}", tags={"users"},
